...
void __stdcall udefrag_unload_library(void);
...
enum {
    ...
    FREE_SPACE,      //1            
    SYSTEM_SPACE,   //2
    SYSTEM_OVER_LIMIT_SPACE,//3
    FRAGM_SPACE,//4
    FRAGM_OVER_LIMIT_SPACE,//5
    UNFRAGM_SPACE,//6
    UNFRAGM_OVER_LIMIT_SPACE,//7
    DIR_SPACE,//8
    DIR_OVER_LIMIT_SPACE,//9
    COMPRESSED_SPACE,//10
    COMPRESSED_OVER_LIMIT_SPACE,//11
    MFT_ZONE_SPACE,//12
    MFT_SPACE,   //13                /* has the highest precedence */
...
char* __stdcall udefrag_get_results(udefrag_progress_info *pi);
void __stdcall udefrag_release_results(char *results);
